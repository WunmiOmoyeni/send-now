  ...
  return (
    <div>
      ...
      <section className="py-16 px-8 sm:px-12 lg:px-16">
        <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center lg:items-start lg:space-x-10">
          {/* Left side */}
          <div className=" text-center lg:text-left px-4 sm:px-6 lg:px-0">
            <h2 className="mb-8 font-[Inter-Regular] text-3xl sm:text-4xl md:text-5xl lg:text-[65px] leading-tight">
              Tested. Verified. Ready.
            </h2>

            <ul className="space-y-6 sm:space-y-8 font-[Inter-Regular] text-lg sm:text-xl md:text-2xl lg:text-[30px] max-w-2xl mx-auto lg:mx-0">
              {[
          ...
          {/* Right side */}
          <div className="mt-12 lg:mt-0 flex justify-center  w-full px-8 py-6 sm:px-6 lg:px-0">
      ...
      <section className="py-16">
        <div className="max-w-[1500px] mx-auto px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center lg:items-start lg:space-x-10 font-[Inter-Regular]">
          {/* Image */}
          ...
          <div className="lg:flex-1 text-left">
            <h2 className="text-[28px] sm:text-[40px] lg:text-[70px] font-[Inter-Regular] mb-[50px] leading-tight ">
              <span className="text-blue-500">Secure</span>, Scalable &amp;
              Lightning Fast
            </h2>
            <ul className="space-y-6 ">
              <li className="text-[18px] sm:text-[22px] lg:text-[35px] font-[Inter-Regular] max-w-[500px] mx-auto lg:mx-0">
