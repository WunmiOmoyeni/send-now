...
export default function NewChat() {
  ...
  return (
    <div className="flex flex-col border border-[#18B1FF4D] rounded-xl bg-white h-[80vh] p-5">
      <h2 className="text-xl font-semibold text-center mb-4">New Chats</h2>

      {/* Buttons */}
      <div className="space-y-2 mb-6 ">
        <button className="flex items-center space-x-3 p-3 rounded-lg w-full hover:bg-gray-50 transition-colors bg-[#18B1FF0D]">
          <div className="w-10 h-10 bg-[#18B1FF] rounded-full flex items-center justify-center text-white">
            👥
          </div>
      ...
      {/* Contacts */}
      <h3 className="text-sm text-gray-500 mb-2">Saved Contacts</h3>
